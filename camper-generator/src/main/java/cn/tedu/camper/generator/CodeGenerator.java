package cn.tedu.camper.generator;
...
public class CodeGenerator {
    ...
    public static String url = "jdbc:mysql://localhost:3306/camper?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    public static String username="root";
    public static String password="a123456";
    //父级别包名称
    public static String parentPackage = "cn.tedu.camper";
    //代码生成的目标路径
    public static String generateTo = "/camper-generator/src/main/java";
    //mapper.xml的生成路径
    public static String mapperXmlPath = "/camper-generator/src/main/resources/mapper";
